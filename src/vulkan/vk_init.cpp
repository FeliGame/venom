...
VkPipelineColorBlendAttachmentState vkinit::color_blend_attachment_enable_state(VkBlendFactor srcBlendFactor, VkBlendFactor dstBlendFactor, VkBlendOp blendOp)
{
    VkPipelineColorBlendAttachmentState colorBlendAttachment = {};
...
VkSamplerCreateInfo vkinit::sampler_create_info(VkFilter filters, VkBorderColor borderColor, VkSamplerAddressMode samplerAddressMode)
{
